Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   DESC
  s.homepage     = "https://github.com/Golden-Flag/ParserExample"
  s.license      = 'MIT License'
  s.author       = { "Jim Dovey" => "jim@dovey.com" }
  s.source       = { :git => "https://github.com/Golden-Flag/ParserExample.git", :tag => s.version.to_s }
  s.source_files = 'Classes/StreamingXMLParser/AQXML*.{h,m}', 'Classes/iPhoneNonatomic.h', 'Classes/HTTPMessage/*.{h,m}', 'Classes/NSError+CFStreamError.{h,m}'
